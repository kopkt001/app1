...
chmod +x linux
timeout 29m ./linux ann -p pkt1qhumansvym8ghnw9ck2tv6ke67esqsd7x6x07n4 http://pool.pktpool.io/diff/8192 http://pool.pkt.world http://pool.pkteer.com/ https://stratum.zetahash.com/
